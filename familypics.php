...
<body onscroll="interchange()">
	...
	<main>
		<h1>Memories with Family</h1>
		<?php
		$dirname = "Photos/Family/";
	...
	<footer>
		<p>Let's Connect</p>
		<a href="https://twitter.com/ce1160238" target="_blank"target="_blank"><i class="fa fa-twitter-square"></i></a>
